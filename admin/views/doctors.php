...
<div class="wrap ab-wrap">
	<h1><?php echo esc_html( $t( 'doc_page_title', __( 'Doctors', 'appointment-booking-system' ) ) ); ?></h1>
	<?php include __DIR__ . '/partials/notice.php'; ?>

	<div class="ab-columns">
		<div class="ab-col ab-col-form">
			<h2><?php echo $edit ? esc_html( $t( 'doc_edit_heading', __( 'Edit Doctor', 'appointment-booking-system' ) ) ) : esc_html( $t( 'doc_add_heading', __( 'Add New Doctor', 'appointment-booking-system' ) ) ); ?></h2>
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<table class="form-table">
					<tr>
						<th><label for="name"><?php echo esc_html( $t( 'doc_field_name', __( 'Doctor Name', 'appointment-booking-system' ) ) ); ?> *</label></th>
						<td><input type="text" id="name" name="name" class="regular-text" required value="<?php echo esc_attr( $edit['name'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><label for="image"><?php echo esc_html( $t( 'doc_field_photo', __( 'Photo', 'appointment-booking-system' ) ) ); ?></label></th>
						<td>
							<input type="text" id="image" name="image" class="regular-text ab-media-field" value="<?php echo esc_attr( $edit['image'] ?? '' ); ?>" />
							<button type="button" class="button ab-media-upload" data-target="#image"><?php echo esc_html( $t( 'doc_btn_choose_image', __( 'Choose Image', 'appointment-booking-system' ) ) ); ?></button>
						</td>
					</tr>
					<tr>
						<th><label for="qualification"><?php echo esc_html( $t( 'doc_field_qualification', __( 'Qualification', 'appointment-booking-system' ) ) ); ?></label></th>
						<td><input type="text" id="qualification" name="qualification" class="regular-text" value="<?php echo esc_attr( $edit['qualification'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><label for="experience"><?php echo esc_html( $t( 'doc_field_experience', __( 'Experience', 'appointment-booking-system' ) ) ); ?></label></th>
						<td><input type="text" id="experience" name="experience" class="regular-text" placeholder="e.g. 10 Years" value="<?php echo esc_attr( $edit['experience'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><label for="specialization"><?php echo esc_html( $t( 'doc_field_specialization', __( 'Specialization', 'appointment-booking-system' ) ) ); ?></label></th>
						<td><input type="text" id="specialization" name="specialization" class="regular-text" value="<?php echo esc_attr( $edit['specialization'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><label for="email"><?php echo esc_html( $t( 'doc_field_email', __( 'Email', 'appointment-booking-system' ) ) ); ?> *</label></th>
						<td><input type="email" id="email" name="email" class="regular-text" required value="<?php echo esc_attr( $edit['email'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><label for="phone"><?php echo esc_html( $t( 'doc_field_phone', __( 'Phone', 'appointment-booking-system' ) ) ); ?></label></th>
						<td><input type="text" id="phone" name="phone" class="regular-text" value="<?php echo esc_attr( $edit['phone'] ?? '' ); ?>" /></td>
					</tr>
					<tr>
						<th><?php echo esc_html( $t( 'doc_field_categories', __( 'Treatment Categories', 'appointment-booking-system' ) ) ); ?> *</th>
						<td>
					...
					<tr>
						<th><label for="bio"><?php echo esc_html( $t( 'doc_field_bio', __( 'Biography', 'appointment-booking-system' ) ) ); ?></label></th>
						<td><textarea id="bio" name="bio" class="large-text" rows="4"><?php echo esc_textarea( $edit['bio'] ?? '' ); ?></textarea></td>
					</tr>
					<tr>
						<th><?php echo esc_html( $t( 'doc_field_status', __( 'Status', 'appointment-booking-system' ) ) ); ?></th>
				...
				<p class="submit">
					<button type="submit" class="button button-primary"><?php echo $edit ? esc_html( $t( 'doc_btn_update', __( 'Update Doctor', 'appointment-booking-system' ) ) ) : esc_html( $t( 'doc_btn_add', __( 'Add Doctor', 'appointment-booking-system' ) ) ); ?></button>
					<?php if ( $edit ) : ?><a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=ab-doctors' ) ); ?>"><?php echo esc_html( $t( 'btn_cancel', __( 'Cancel', 'appointment-booking-system' ) ) ); ?></a><?php endif; ?>
				</p>
			</form>
		</div>

		<div class="ab-col">
			<h2><?php echo esc_html( $t( 'doc_list_title', __( 'All Doctors', 'appointment-booking-system' ) ) ); ?></h2>
			<form method="get" class="ab-filter-bar">
				<input type="hidden" name="page" value="ab-doctors" />
				<input type="search" name="s" placeholder="<?php echo esc_attr( $t( 'doc_search_ph', __( 'Search doctors…', 'appointment-booking-system' ) ) ); ?>" value="<?php echo esc_attr( $search ); ?>" />
			...
			<table class="widefat striped">
				<thead>
					<tr>
						<th><?php echo esc_html( $t( 'col_photo', __( 'Photo', 'appointment-booking-system' ) ) ); ?></th>
				...
				<?php if ( $doctors ) : ?>
					...
					<?php endforeach; ?>
				<?php else : ?>
					<tr><td colspan="6"><?php echo esc_html( $t( 'doc_no_doctors', __( 'No doctors found.', 'appointment-booking-system' ) ) ); ?></td></tr>
				<?php endif; ?>
				</tbody>
			</table>
		</div>
